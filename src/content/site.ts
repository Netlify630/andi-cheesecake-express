...
export const site = {
  ...
  baker: {
    ...
    role: "Baker · Owner",
    bio:
      "Hello! I'm Andie, aka \"The Cheesecake Lady.\" The first time I tried cheesecake, I was in Turkey, and I loved it. I went back for thirds. After that, cheesecake kind of stuck with me.\n\nI had always wanted to try making a cheesecake, but I was running a different sourdough treats business, and it always felt like too much. At the time, I was looking for a way to expand my business.\n\nThen we went to Kauai, a beautiful island in Hawaii, and it was there that I got my spark of inspiration. There was a small cheesecake self-serve fridge that served the best poi lilikoi cheesecake. After that, the spark bloomed. I wanted to make a self-serve fridge here in Idaho. So I did.",
  },
